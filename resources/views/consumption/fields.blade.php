...
<div class="row g-3">
    ...
    <div class="col-md-2 mb-3">
        <label>&nbsp;</label>
        <button type="button" class="form-control btn btn-outline-secondary" @click="onDetailsClick" :disabled="disable_details_button"><i class="feather-20 align-text-bottom me-1" data-feather="info"></i>Details</button>
    </div>
