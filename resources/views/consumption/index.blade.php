...
@section('content')
    <div class="container px-3 px-md-4" style="max-width: 1180px;">
        ...
        <div class="d-flex justify-content-between align-items-center gap-3 mb-4">
            <h1 class="ht-page-title mb-0">Consumptions</h1>
            <a class="btn btn-primary d-md-none text-nowrap" href="{{ route('consumptions.create') }}" role="button"><i class="feather-20 align-text-bottom me-1" data-feather="plus"></i>Add</a>
        </div>
        ...
        <div class="card mb-5">
            <div class="card-body p-4">
                <form action="{{ route('consumptions.copyDate') }}" method="post" class="d-flex flex-column flex-sm-row align-items-stretch align-items-sm-center gap-2 gap-sm-3">
                    @csrf
